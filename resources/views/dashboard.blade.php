            ...
            <div class="dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="bg-warning">
                    <div class="container text-center">
                        ...
                        <div class="row justify-content-around">
                            <div class="card text-dark bg-light mb-3 text-center col-4 hover" style="max-width: 18rem;">
                                <div class="card-header"><b>Media nacional</b></div>
                                <div class="card-body">
                                    <h5 id="mediaNacional" class="card-title"></h5>
                        ...
                        <div class="row justify-content-around">
                            <div class="card text-dark bg-light mb-3 text-center col-4 hover" style="max-width: 18rem;">
                                <div class="card-header"><b>Media nacional de examenes realizados</b></div>
                                <div class="card-body">
                                    <h5 id="mediaExamenesNacional" class="card-title"></h5>
                                    <p class="card-text">A contar desde la fecha de publicacion de la presente convocatoria</p>
                                </div>
                            </div>
                            <div class="card text-dark bg-light mb-3 text-center col-4 hover" style="max-width: 18rem;">
